...
class CreateWholesaleProvisioningOrderDatabaseEntriesStepUTest extends AbstractWorkflowStepTest {
    ...
    @InjectMocks
    CreateWholesaleProvisioningOrderDatabaseEntriesStep unitToTest;
    ...
    public void executeStep() throws Exception {
        ...
        doNothing().when(provisioningHandler)
                .createWholesaleProvisioningDatabaseEntries(RT_ORDER,
                        RT_CUSTOMER, WS_ORDER, WS_CUSTOMER, WS_PROVISIONING_ID, CURRENT_TENANT);
