...
@Slf4j
@Component
public class CreateWholesaleProvisioningOrderDatabaseEntriesStep extends AbstractBaseStep {

    private final ProvisioningHandler provisioningHandler;

    public CreateWholesaleProvisioningOrderDatabaseEntriesStep(ObjectMapper objectMapper, WorkflowUtil workflowUtil, ProvisioningHandler provisioningHandler) {
    ...
    public void executeStep(DelegateExecution execution) throws JsonProcessingException {
        provisioningHandler.createWholesaleProvisioningDatabaseEntries(
