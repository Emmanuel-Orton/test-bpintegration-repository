...
@Slf4j
@Component
public class SetServiceOrderToInProgressStep extends AbstractBaseStep {

    private final ProvisioningHandler provisioningHandler;

    public SetServiceOrderToInProgressStep(ObjectMapper objectMapper, WorkflowUtil workflowUtil, ProvisioningHandler provisioningHandler) {
    ...
    public void executeStep(DelegateExecution execution) throws JsonProcessingException {
        provisioningHandler.setServiceOrderInProgress(
