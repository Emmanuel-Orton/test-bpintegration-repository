    ...
    <@section id="description" label="i18n.taskmgmt.taskdetail.description.ftl">
        <@row id="trTaskDescription">
            <div class="formElement" id="divtxtDescription">
                The Change Order document for wholesale order
                <a href="${taskDetailsDto.inputParam.WS_CSM_ORDER_LINK}" class`="telusGreenTextUnderlined">${taskDetailsDto.inputParam.WS_ORDER_ID}</a>
                needs to be updated.
            </div>
        </@row>
    </@section>
